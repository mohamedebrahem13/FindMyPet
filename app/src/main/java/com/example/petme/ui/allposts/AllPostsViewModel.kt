...
@HiltViewModel
class AllPostsViewModel @Inject constructor(private val getPostsSortedByTimestampUseCase: GetPostsSortedByTimestampUseCase,private val getCurrentUserUseCase: GetCurrentUserUseCase): ViewModel(){
